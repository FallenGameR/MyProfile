...
# Tools instalation
choco install powershell-core googlechrome firacode less microsoft-windows-terminal vscode git gitextensions kdiff3 windirstat beyondcompare gimp ilspy sysinternals mp3tag far mls-software-openssh -y

# linqpad5 CRC broken, find alternatives, for now we are taking it from OneDrive and MyProfile
#choco install linqpad5 -y

# Visual studio
choco install visualstudio2019enterprise visualstudio2019-workload-azure visualstudio2019-workload-manageddesktop visualstudio2019-workload-nativedesktop visualstudio2019-workload-netcoretools -y
...
if( $HomeSpecific )
{
    choco install -y steam geforce-game-ready-driver
