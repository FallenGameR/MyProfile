...
. Import-AsDotSource "$PSScriptRoot/Scripts/$($PSVersionTable.Platform)/Initialize-Apps.ps1"
. Import-AsDotSource "$PSScriptRoot/Scripts/$($PSVersionTable.Platform)/Initialize-Root.ps1" (Test-Elevated)
. Import-AsDotSource "$PSScriptRoot/Scripts/$($PSVersionTable.Platform)/Initialize-System.ps1"
